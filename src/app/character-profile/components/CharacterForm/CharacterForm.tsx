    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col flex-wrap flex justify-center gap-3">
        <div className="bg-textBg basis-full p-2 rounded">
          <label className="[font-family:'Lexend-Regular',Helvetica] font-normal text-black">
            Name:{" "}
          </label>
          <input
            className="bg-textBg"
        ...
        <div className="bg-textBg basis-full p-2 rounded">
          ...
          <input
            className="bg-textBg"
            {...register("Occupation", { required: true, maxLength: 30 })}
          />
        </div>
        <div className="flex flex-row justify-center gap-4">
          ...
          <div className="bg-textBg w-1/2 p-2 rounded h-10">
            ...
            <select className="bg-textBg appearance-none" {...register("Sex")}>
        ...
        <div className="bg-textBg basis-full p-2 rounded">
          ...
          <input
            className="bg-textBg"
            {...register("BirthPlace", { pattern: /^[A-Za-z]+$/i })}
          />
        </div>
        <div className="bg-textBg basis-full p-2 rounded">
          <label className="[font-family:'Lexend-Regular',Helvetica] font-normal text-black">
          ...
          <input
            className="bg-textBg"
            {...register("Residence", { pattern: /^[A-Za-z]+$/i })}
          />
        </div>
      </div>
    </form>
